var db = jQuery.getJSON("http://10.100.203.78:3011/data/1");
console.log(db)
...
function rd() {
    ...
    setInterval(function () {
        ...
        data.datasets[0].data.push({
            x: Date.now(),
            y: Object.values(db.responseJSON.nhiệt_độ.smt1)[Object.values(db.responseJSON.nhiệt_độ.smt1).length - 1]
        })
        //smt2
        data.datasets[1].data.push({
            x: Date.now(),
            y: Object.values(db.responseJSON.nhiệt_độ.smt2)[Object.values(db.responseJSON.nhiệt_độ.smt1).length - 1]
        });
        //smt3
        data.datasets[2].data.push({
            x: Date.now(),
            y: Object.values(db.responseJSON.nhiệt_độ.smt3)[Object.values(db.responseJSON.nhiệt_độ.smt1).length - 1]
        });
        //smt4
        data.datasets[3].data.push({
            x: Date.now(),
            y: Object.values(db.responseJSON.nhiệt_độ.smt4)[Object.values(db.responseJSON.nhiệt_độ.smt1).length - 1]
        });
        //lazer5
        data.datasets[4].data.push({
            x: Date.now(),
            y: Object.values(db.responseJSON.nhiệt_độ.lazer1)[Object.values(db.responseJSON.nhiệt_độ.smt1).length - 1]
        });
        //lazer6
        data.datasets[5].data.push({
            x: Date.now(),
            y: Object.values(db.responseJSON.nhiệt_độ.lazer2)[Object.values(db.responseJSON.nhiệt_độ.smt1).length - 1]
        });
        //Coerlay7 
        data.datasets[6].data.push({
            x: Date.now(),
            y: Object.values(db.responseJSON.nhiệt_độ.coverlay1)[Object.values(db.responseJSON.nhiệt_độ.smt1).length - 1]
        });
        //Coverlay8
        data.datasets[7].data.push({
            x: Date.now(),
            y: Object.values(db.responseJSON.nhiệt_độ.coverlay2)[Object.values(db.responseJSON.nhiệt_độ.smt1).length - 1]
        });
        //Exposure9
        data.datasets[8].data.push({
            x: Date.now(),
            y: Object.values(db.responseJSON.nhiệt_độ.exposure1)[Object.values(db.responseJSON.nhiệt_độ.smt1).length - 1]
        });
        //Exposure10
        data.datasets[9].data.push({
            x: Date.now(),
            y: Object.values(db.responseJSON.nhiệt_độ.exposure2)[Object.values(db.responseJSON.nhiệt_độ.smt1).length - 1]
        });
        ...
        data1.datasets[0].data.push({
            x: Date.now(),
            y: Object.values(db.responseJSON.độ_ẩm.smt1)[Object.values(db.responseJSON.độ_ẩm.smt1).length - 1]
        });
        //smt2
        data1.datasets[1].data.push({
            x: Date.now(),
            y: Object.values(db.responseJSON.độ_ẩm.smt2)[Object.values(db.responseJSON.độ_ẩm.smt2).length - 1]
        });
        //smt3
        data1.datasets[2].data.push({
            x: Date.now(),
            y: Object.values(db.responseJSON.độ_ẩm.smt3)[Object.values(db.responseJSON.độ_ẩm.smt3).length - 1]
        });
        //smt4
        data1.datasets[3].data.push({
            x: Date.now(),
            y: Object.values(db.responseJSON.độ_ẩm.smt4)[Object.values(db.responseJSON.độ_ẩm.smt4).length - 1]
        });
        // lazer5
        data1.datasets[4].data.push({
            x: Date.now(),
            y: Object.values(db.responseJSON.độ_ẩm.lazer1)[Object.values(db.responseJSON.độ_ẩm.lazer1).length - 1]
        });
        //lazer6
        data1.datasets[5].data.push({
            x: Date.now(),
            y: Object.values(db.responseJSON.độ_ẩm.lazer2)[Object.values(db.responseJSON.độ_ẩm.lazer2).length - 1]
        });
        //Coerlay7 
        data1.datasets[6].data.push({
            x: Date.now(),
            y: Object.values(db.responseJSON.độ_ẩm.coverlay1)[Object.values(db.responseJSON.độ_ẩm.coverlay1).length - 1]
        });
        //Coverlay8
        data1.datasets[7].data.push({
            x: Date.now(),
            y: Object.values(db.responseJSON.độ_ẩm.coverlay2)[Object.values(db.responseJSON.độ_ẩm.coverlay2).length - 1]
        });
        //Exposure9
        data1.datasets[8].data.push({
            x: Date.now(),
            y: Object.values(db.responseJSON.độ_ẩm.exposure1)[Object.values(db.responseJSON.độ_ẩm.exposure1).length - 1]
        });
        //Exposure10
        data1.datasets[9].data.push({
            x: Date.now(),
            y: Object.values(db.responseJSON.độ_ẩm.exposure2)[Object.values(db.responseJSON.độ_ẩm.exposure2).length - 1]
        });
    }, 1);
    ...
    function read() {
        ...
        if (Object.values(db.responseJSON.nhiệt_độ.smt1)[Object.values(db.responseJSON.nhiệt_độ.smt1).length - 1] > 26 || Object.values(db.responseJSON.nhiệt_độ.smt1)[Object.values(db.responseJSON.nhiệt_độ.smt1).length - 1] < 20) {
        ...
        if (Object.values(db.responseJSON.nhiệt_độ.smt2)[Object.values(db.responseJSON.nhiệt_độ.smt2).length - 1] > 26 || Object.values(db.responseJSON.nhiệt_độ.smt2)[Object.values(db.responseJSON.nhiệt_độ.smt2).length - 1] < 20) {
        ...
        if (Object.values(db.responseJSON.nhiệt_độ.smt3)[Object.values(db.responseJSON.nhiệt_độ.smt3).length - 1] > 26 || Object.values(db.responseJSON.nhiệt_độ.smt3)[Object.values(db.responseJSON.nhiệt_độ.smt3).length - 1] < 20) {
        ...
        if (Object.values(db.responseJSON.nhiệt_độ.smt4)[Object.values(db.responseJSON.nhiệt_độ.smt4).length - 1] > 26 || Object.values(db.responseJSON.nhiệt_độ.smt4)[Object.values(db.responseJSON.nhiệt_độ.smt4).length - 1] < 20) {
        ...
        if (Object.values(db.responseJSON.nhiệt_độ.lazer1)[Object.values(db.responseJSON.nhiệt_độ.lazer1).length - 1] > 23 || Object.values(db.responseJSON.nhiệt_độ.lazer1)[Object.values(db.responseJSON.nhiệt_độ.lazer1).length - 1] < 20) {
        ...
        if (Object.values(db.responseJSON.nhiệt_độ.lazer2)[Object.values(db.responseJSON.nhiệt_độ.lazer2).length - 1] > 23 || Object.values(db.responseJSON.nhiệt_độ.lazer2)[Object.values(db.responseJSON.nhiệt_độ.lazer2).length - 1] < 20) {
        ...
        if (Object.values(db.responseJSON.nhiệt_độ.coverlay1)[Object.values(db.responseJSON.nhiệt_độ.coverlay1).length - 1] > 23 || Object.values(db.responseJSON.nhiệt_độ.coverlay1)[Object.values(db.responseJSON.nhiệt_độ.coverlay1).length - 1] < 20) {
        ...
        if (Object.values(db.responseJSON.nhiệt_độ.coverlay2)[Object.values(db.responseJSON.nhiệt_độ.coverlay2).length - 1] > 26 || Object.values(db.responseJSON.nhiệt_độ.coverlay2)[Object.values(db.responseJSON.nhiệt_độ.coverlay2).length - 1] < 20) {
        ...
        if (Object.values(db.responseJSON.nhiệt_độ.exposure1)[Object.values(db.responseJSON.nhiệt_độ.exposure1).length - 1] > 23 || Object.values(db.responseJSON.nhiệt_độ.exposure1)[Object.values(db.responseJSON.nhiệt_độ.exposure1).length - 1] < 20) {
        ...
        if (Object.values(db.responseJSON.nhiệt_độ.exposure2)[Object.values(db.responseJSON.nhiệt_độ.exposure2).length - 1] > 23 || Object.values(db.responseJSON.nhiệt_độ.exposure2)[Object.values(db.responseJSON.nhiệt_độ.exposure2).length - 1] < 20) {
        ...
        for (var i = 1; i <= daysInMonth; i++) {
            if (i < day) {
                table.innerHTML +=
                    ...
                    '<td class="column2 style5">' + ((db.responseJSON.nhiệt_độ.smt1[i] + db.responseJSON.nhiệt_độ.smt2[i] + db.responseJSON.nhiệt_độ.smt3[i] + db.responseJSON.nhiệt_độ.smt4[i]) / 4).toFixed(1) + '℃</td>' +
                    '<td class="column3 style4">' + ((db.responseJSON.độ_ẩm.smt1[i] + db.responseJSON.độ_ẩm.smt2[i] + db.responseJSON.độ_ẩm.smt3[i] + db.responseJSON.độ_ẩm.smt4[i]) / 4).toFixed(1) + '%</td>' +
                    '<td class="column4 style5">' + ((db.responseJSON.nhiệt_độ.lazer1[i] + db.responseJSON.nhiệt_độ.lazer2[i]) / 2).toFixed(1) + '℃</td>' +
                    '<td class="column5 style4">' + ((db.responseJSON.độ_ẩm.lazer1[i] + db.responseJSON.độ_ẩm.lazer2[i]) / 2).toFixed(1) + '%</td>' +
                    '<td class="column6 style5">' + ((db.responseJSON.nhiệt_độ.coverlay1[i] + db.responseJSON.nhiệt_độ.coverlay2[i]) / 2) .toFixed(1)+ '℃</td>' +
                    '<td class="column7 style4">' + ((db.responseJSON.độ_ẩm.coverlay1[i] + db.responseJSON.độ_ẩm.coverlay2[i]) / 2) .toFixed(1)+ '%</td>' +
                    '<td class="column8 style5">' + ((db.responseJSON.nhiệt_độ.exposure1[i] + db.responseJSON.nhiệt_độ.exposure2[i]) / 2).toFixed(1) + '℃</td>' +
                    '<td class="column9 style4">' + ((db.responseJSON.độ_ẩm.exposure1[i] + db.responseJSON.độ_ẩm.exposure2[i]) / 2).toFixed(1) + '%</td>' +
                    "</tr>";
            }
            else if (i == day) {
                table.innerHTML +=
