...
function rd() {
    ...
    function read() {
        for (var i = 0; i < 10; i++) {
            document.getElementById("left-wapper").getSVGDocument().getElementById(`temp${i + 1}`).textContent = config.data.datasets[i].data[config.data.datasets[i].data.length - 1].y.toFixed(1);
            document.getElementById("left-wapper").getSVGDocument().getElementById(`hum${i + 1}`).textContent = config1.data.datasets[i].data[config1.data.datasets[i].data.length - 1].y.toFixed(1);
        }
        ...
        if (Object.values(db.nhiệt_độ.smt1)[Object.values(db.nhiệt_độ.smt1).length - 1] > 26 || Object.values(db.nhiệt_độ.smt1)[Object.values(db.nhiệt_độ.smt1).length - 1] < 20) {
            document.getElementById("left-wapper").getSVGDocument().getElementById(`fill1`).style.fill = "red";
        }
        else {
            document.getElementById("left-wapper").getSVGDocument().getElementById(`fill1`).style.fill = "black";
        }
        ...
        if (Object.values(db.nhiệt_độ.smt2)[Object.values(db.nhiệt_độ.smt2).length - 1] > 26 || Object.values(db.nhiệt_độ.smt2)[Object.values(db.nhiệt_độ.smt2).length - 1] < 20) {
            document.getElementById("left-wapper").getSVGDocument().getElementById(`fill2`).style.fill = "red";
        }
        else {
            document.getElementById("left-wapper").getSVGDocument().getElementById(`fill2`).style.fill = "black";
        }
        ...
        if (Object.values(db.nhiệt_độ.smt3)[Object.values(db.nhiệt_độ.smt3).length - 1] > 26 || Object.values(db.nhiệt_độ.smt3)[Object.values(db.nhiệt_độ.smt3).length - 1] < 20) {
            document.getElementById("left-wapper").getSVGDocument().getElementById(`fill3`).style.fill = "red";
        }
        else {
            document.getElementById("left-wapper").getSVGDocument().getElementById(`fill3`).style.fill = "black";
        }
        ...
        if (Object.values(db.nhiệt_độ.smt4)[Object.values(db.nhiệt_độ.smt4).length - 1] > 26 || Object.values(db.nhiệt_độ.smt4)[Object.values(db.nhiệt_độ.smt4).length - 1] < 20) {
            document.getElementById("left-wapper").getSVGDocument().getElementById(`fill4`).style.fill = "red";
        }
        else {
        ...
        if (Object.values(db.nhiệt_độ.lazer2)[Object.values(db.nhiệt_độ.lazer2).length - 1] > 23 || Object.values(db.nhiệt_độ.lazer2)[Object.values(db.nhiệt_độ.lazer2).length - 1] < 17) {
            ...
            document.getElementById("left-wapper").getSVGDocument().getElementById(`fill6`).style.fill = "black";
        }
        ...
        if (Object.values(db.nhiệt_độ.coverlay1)[Object.values(db.nhiệt_độ.coverlay1).length - 1] > 23 || Object.values(db.nhiệt_độ.coverlay1)[Object.values(db.nhiệt_độ.coverlay1).length - 1] < 17) {
            ...
            document.getElementById("left-wapper").getSVGDocument().getElementById(`fill7`).style.fill = "black";
        }
        ...
        if (Object.values(db.nhiệt_độ.coverlay2)[Object.values(db.nhiệt_độ.coverlay2).length - 1] > 26 || Object.values(db.nhiệt_độ.coverlay2)[Object.values(db.nhiệt_độ.coverlay2).length - 1] < 17) {
            ...
            document.getElementById("left-wapper").getSVGDocument().getElementById(`fill8`).style.fill = "black";
        }
        ...
        for(var i = 0; i < 10; i++){
            if(config1.data.datasets[i].data[config1.data.datasets[i].data.length - 1].y < 40 || config1.data.datasets[i].data[config1.data.datasets[i].data.length - 1].y > 60){
                document.getElementById("left-wapper").getSVGDocument().getElementById(`humi${i + 1}`).style.fill = "red";
            } else {
                document.getElementById("left-wapper").getSVGDocument().getElementById(`humi${i + 1}`).style.fill = "black";
            }
        }


        // Nhiệt độ
        var temp1 = document.getElementById("left-wapper").getSVGDocument().getElementById("temp1").textContent;
        var temp2 = document.getElementById("left-wapper").getSVGDocument().getElementById("temp2").textContent;
        var temp3 = document.getElementById("left-wapper").getSVGDocument().getElementById("temp3").textContent;
        var temp4 = document.getElementById("left-wapper").getSVGDocument().getElementById("temp4").textContent;
        var temp5 = document.getElementById("left-wapper").getSVGDocument().getElementById("temp5").textContent;
        var temp6 = document.getElementById("left-wapper").getSVGDocument().getElementById("temp6").textContent;
        var temp7 = document.getElementById("left-wapper").getSVGDocument().getElementById("temp7").textContent;
        var temp8 = document.getElementById("left-wapper").getSVGDocument().getElementById("temp8").textContent;
        var temp9 = document.getElementById("left-wapper").getSVGDocument().getElementById("temp9").textContent;
        var temp10 = document.getElementById("left-wapper").getSVGDocument().getElementById("temp10").textContent;

        // Độ ẩm
        var hum1 = document.getElementById("left-wapper").getSVGDocument().getElementById("hum1").textContent;
        var hum2 = document.getElementById("left-wapper").getSVGDocument().getElementById("hum2").textContent;
        var hum3 = document.getElementById("left-wapper").getSVGDocument().getElementById("hum3").textContent;
        var hum4 = document.getElementById("left-wapper").getSVGDocument().getElementById("hum4").textContent;
        var hum5 = document.getElementById("left-wapper").getSVGDocument().getElementById("hum5").textContent;
        var hum6 = document.getElementById("left-wapper").getSVGDocument().getElementById("hum6").textContent;
        var hum7 = document.getElementById("left-wapper").getSVGDocument().getElementById("hum7").textContent;
        var hum8 = document.getElementById("left-wapper").getSVGDocument().getElementById("hum8").textContent;
        var hum9 = document.getElementById("left-wapper").getSVGDocument().getElementById("hum9").textContent;
        var hum10 = document.getElementById("left-wapper").getSVGDocument().getElementById("hum10").textContent;
